...
function Login() {
return ( <section className="fundo">

```
  <div>
    <img
      src="./assets/images/adiv.png"
      alt=""
      className="adiv-png"
    />
  ...
  <section className="fundo-azul">
    <div className="maior">
      ...
      <div className="texts">
        <h1>
          Bem vindos de <span className="cor">Volta</span>
        </h1>
      ...
      <div className="iconis">
        ...
        <div className="estastic">
          <img
            style={{ width: "80px" }}
            src="./assets/images/Estástitica.png"
            alt=""
          />
  ...
  <div className="login">
    <div className="itens">
      ...
      <div className="inpp2">
        ...
        <div className="ultimo">
          ...
          <div className="esqueci">
            <Link className="esqueciLI" to="/semSenha">
      ...
      <div className="naotem">
        ...
        <Link className="esqueciLI" to="/criação">
